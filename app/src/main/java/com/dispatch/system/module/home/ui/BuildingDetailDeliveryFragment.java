 ...
 * @date 2020/7/23
 */
public class BuildingDetailDeliveryFragment extends BaseFragment {
    ...
    public BuildingDetailDeliveryFragment(String buildingCode, String houseNumber) {
...
//        }
    ...
    private void requestData() {
        showLoading();
        ApiClient.getInstance().getDeliveryDetailList(buildingCode, houseNumber,
