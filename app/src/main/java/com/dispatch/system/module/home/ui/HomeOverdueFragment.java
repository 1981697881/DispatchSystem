 ...
 * @date 2020/7/18
 */
public class HomeOverdueFragment extends BaseFragment {
    ...
    private void requestData() {
        ApiClient.getInstance().getOverdueTask(new MyObserver<MineTodayTaskBean>() {
            @Override
            ...
            protected void onSuccess(MineTodayTaskBean mineTodayTaskBean) {
                ...
                if (adapter == null) {
                    adapter = new HomeTaskAdapter(getContext(), group, false, true,false);
