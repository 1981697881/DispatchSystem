 ...
 * @date 2020/7/18
 */
public class HomeMineTaskFragment extends BaseFragment {
    ...
    protected int bindLayout() {
        return R.layout.fragment_home_mine_task;
    }
...
//    }
    ...
    private void requestData() {
        ApiClient.getInstance().getMineTodayTask(new MyObserver<MineTodayTaskBean>() {
            @Override
            ...
            protected void onSuccess(MineTodayTaskBean mineTodayTaskBean) {
                ...
                if (mineTodayTaskBean.getData() == null
                ...
                if (adapter == null) {
                    adapter = new HomeTaskAdapter(getContext(), group, true, false,false);
            ...
            protected void onError(String msg) {
                if (msg.equals("401")) {
                    LoginActivity.move(getActivity());
                    getActivity().finish();
                }
                refreshLayout.finishRefresh(500);
            }
